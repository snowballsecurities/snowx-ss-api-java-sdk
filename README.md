...
|------- |--------------|
| 60000  | 操作成功     |
| 70000  | 服务器开小差，（服务器内部异常，请联系客服解决）|
| 70010  | 重试次数过多，（接口访问频率太高被限制）|
| 70021  | 当前状态无权限操作，（密码错误或者token过期）|
| 79000  | 参数错误，（传递的参数不符合校验规则）|
| 798000 | 无效的请求 |
| 798001 | 错误的请求参数:%s |
| 798002 | 请先绑定盈透证券账户,再继续操作 |
| 798003 | 请求撤销的委托单不存在 |
| 798004 | 当前委托单无法撤销 |
| 798005 | 各种业务错误，如果用户无法解决请联系客服 |
| 798006 | 委托数量超过限制,IB最大支持500000 |
| 798006 | 委托单状态变化无法撤销,请刷新后重试 |
| 798009 | 无法撤单，请联系客服 |
| 798010 | 无法撤单，请稍后再试 |
| 798011 | 每手股数错误，请重新输入 |
| 798012 | 货币兑换金额过低,请提高兑换金额重新提交 |
| 798013 | 请输入止损价 |
| 798014 | 请输入追踪价差或百分比 |
| 798015 | 追踪价差和百分比只能输入一个 |
| 798016 | 请求修改的委托单不存在 |
| 798017 | 当前委托单无法修改 |
| 798018 | 错误的委托单修改类型 |
| 798019 | 涡轮/牛熊证不支持盘后竞价单 |
| 798020 | 该客户端版本过旧，已不再维护，请更新至最新版 |
| 798021 | 没找到对应的证券，请稍后再试 |
| 798022 | 服务器每日例行维护中，预计15分钟内结束，请稍后再试 |
| 798023 | 网络连接异常，请稍后再试 |
| 798024 | 没有该品类交易权限 |
| 798025 | 委托单已结束，状态无法更新 |
| 798026 | 服务器开小差了 |
| 798027 | 不支持的订单类型 |
| 798028 | 不支持该品类交易 |
| 798029 | 暂无交易权限,请联系客服 |
| 798030 | 若要交易杠杆类产品，您必须登录盈透证券后台开启对应交易权限，具体可在“联系客服”中回复“开通交易权限”获取对应指引帮助 |
| 798031 | 无此订单 |
| 799000 | 当前修改订单状态未知 |
